...
import org.jasig.cas.ticket.BadImgVerifyCodeAuthenticationException;
import org.jasig.cas.ticket.NullImgVerifyCodeAuthenticationException;
...
public class AuthenticationViaFormAction {
    ...
    public final String validatorCode(final RequestContext context,
        ...
        if (submitAuthcode.equalsIgnoreCase((String) session.getAttribute("KAPTCHA_SESSION_KEY"))) {
            return "success";
        }
